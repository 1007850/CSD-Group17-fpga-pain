...
module bram #(
    ...
    localparam _MP_WIDTH_1382569044 = WIDTH;
    localparam _MP_ENTRIES_1382569044 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1382569044)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1382569044-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1382569044-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1382569044),
        .ENTRIES(_MP_ENTRIES_1382569044)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1114135666 = WIDTH;
    localparam _MP_ENTRIES_1114135666 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1114135666)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1114135666-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1114135666-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1114135666),
        .ENTRIES(_MP_ENTRIES_1114135666)
    ) bram2 (
        .clk(clk),
