...
<<<<<<< HEAD
    localparam _MP_WIDTH_206073714 = WIDTH;
    localparam _MP_ENTRIES_206073714 = ENTRIES;
    logic M_ram_wclk;
    logic [((($clog2(_MP_ENTRIES_206073714)-1) - (0) + 1))-1:0] M_ram_waddr;
    logic [(((_MP_WIDTH_206073714-1) - (0) + 1))-1:0] M_ram_write_data;
    logic M_ram_write_enable;
    logic M_ram_rclk;
    logic [((($clog2(_MP_ENTRIES_206073714)-1) - (0) + 1))-1:0] M_ram_raddr;
    logic [(((_MP_WIDTH_206073714-1) - (0) + 1))-1:0] M_ram_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_206073714),
        .ENTRIES(_MP_ENTRIES_206073714)
=======
