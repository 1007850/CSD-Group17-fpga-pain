...
module fifo #(
    ...
    localparam _MP_WIDTH_1974809494 = WIDTH;
    localparam _MP_ENTRIES_1974809494 = ENTRIES;
    logic M_ram_wclk;
    logic [((($clog2(_MP_ENTRIES_1974809494)-1) - (0) + 1))-1:0] M_ram_waddr;
    logic [(((_MP_WIDTH_1974809494-1) - (0) + 1))-1:0] M_ram_write_data;
    logic M_ram_write_enable;
    logic M_ram_rclk;
    logic [((($clog2(_MP_ENTRIES_1974809494)-1) - (0) + 1))-1:0] M_ram_raddr;
    logic [(((_MP_WIDTH_1974809494-1) - (0) + 1))-1:0] M_ram_read_data;
    
    simple_dual_port_ram #(
        .WIDTH(_MP_WIDTH_1974809494),
        .ENTRIES(_MP_ENTRIES_1974809494)
    ) ram (
        .wclk(M_ram_wclk),
        .waddr(M_ram_waddr),
