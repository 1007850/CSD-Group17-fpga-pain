...
module bram #(
    ...
    localparam _MP_WIDTH_1975318305 = WIDTH;
    localparam _MP_ENTRIES_1975318305 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1975318305)-1) - (0) + 1))-1:0] M_bram1_address;
    logic [(((_MP_WIDTH_1975318305-1) - (0) + 1))-1:0] M_bram1_read_data;
    logic [(((_MP_WIDTH_1975318305-1) - (0) + 1))-1:0] M_bram1_write_data;
    logic M_bram1_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1975318305),
        .ENTRIES(_MP_ENTRIES_1975318305)
    ) bram1 (
        .clk(clk),
    ...
    localparam _MP_WIDTH_1298139890 = WIDTH;
    localparam _MP_ENTRIES_1298139890 = ENTRIES;
    logic [((($clog2(_MP_ENTRIES_1298139890)-1) - (0) + 1))-1:0] M_bram2_address;
    logic [(((_MP_WIDTH_1298139890-1) - (0) + 1))-1:0] M_bram2_read_data;
    logic [(((_MP_WIDTH_1298139890-1) - (0) + 1))-1:0] M_bram2_write_data;
    logic M_bram2_write_enable;
    
    simple_ram #(
        .WIDTH(_MP_WIDTH_1298139890),
        .ENTRIES(_MP_ENTRIES_1298139890)
    ) bram2 (
        .clk(clk),
