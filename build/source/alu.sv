...
module alu #(
    ...
    localparam _MP_SIZE_2015559286 = SIZE;
    logic [(_MP_SIZE_2015559286)-1:0] M_adder_a;
    logic [(_MP_SIZE_2015559286)-1:0] M_adder_b;
    logic [5:0] M_adder_alufn_signal;
    logic [(_MP_SIZE_2015559286)-1:0] M_adder_out;
    logic M_adder_z;
    logic M_adder_v;
    logic M_adder_n;
    
    adder #(
        .SIZE(_MP_SIZE_2015559286)
    ) adder (
        .a(M_adder_a),
        .b(M_adder_b),
    ...
    localparam _MP_SIZE_467614429 = 6'h20;
